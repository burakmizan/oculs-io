...
import { CODE_EXTS, SKIP_DIRS, MAX_FILES, MAX_LINES, MAX_FILE_BYTES, MAX_ZIP_BYTES, SEVERITY_WEIGHTS, VALID_SEV, VALID_EXPL, makeFingerprint, callGeminiSast } from "@/lib/ai/zip-sast"
  ...
  try {
    await db
      ...
      .set({
        ...
        summary: { ...summary, riskScore, codeFiles } as any,
      })
